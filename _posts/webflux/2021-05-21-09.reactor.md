...
category: webflux
author: jhhong0509
short-description: What is Reactor?
---
------
...
Reactor는 Java8의 함수형 프로그래밍을 포함하고 있으며, 특히 [CompletableFuture](2021-05-21-08.future.md)와 [Stream](./5.stream_api.md), Duration을 사용하여 **완전한 논 블로킹**으로 동작한다.
